...
const file_gcsystemmsgs_proto_rawDesc = "" +
	"\n" +
	"\x12gcsystemmsgs.proto\x12\x06tf2_gc\"\x91\x01\n" +
	...
	"\tgceresult\x18\x01 \x01(\rR\tgceresult*\xc4\x1a\n" +
	...
	"$k_EGCMsgVSReportedSuspiciousActivity\x10\xfd\x03\x12(\n" +
	...
	" k_ESOMsg_CacheSubscribedUpToDate\x10\x1d*\xeb\x01\n" +
	...
	"\x13k_EMsgGCServerHello\x10\xa7\x1f\x12\x1a\n" +
	"\x15k_EMsgGCClientGoodbye\x10\xa8\x1f\x12\x1a\n" +
	"\x15k_EMsgGCServerGoodbye\x10\xa9\x1f*\xec\x02\n" +
	"\n" +
	"EGCToGCMsg\x12\x1a\n" +
	...
	"\x1ek_EMsgGCToGCSOCacheUnsubscribe\x10\x9f\x01B/H\x01Z(github.com/lemon4ksan/g-man/protobuf/tf2\x80\x01\x00"
